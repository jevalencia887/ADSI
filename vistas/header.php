...
<head>
  ...
  <title> Sistema Inventario Kevin Sport </title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>KEVIN SPORT</b></span>
      <!--<img src="public/images/logo-_1_.ico" alt="">-->
    </a>
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  ...
                  <small>Administrador desde Noviembre 2019</small>
                </p>
              </li>
              <!-- Menu Body -->
              <!--<li class="user-body">
        ...
        <?php if($_SESSION["productos"]==1)
         ...
         <li class="">
          <a href="productos.php">
            <i class="fa fa-tasks" aria-hidden="true"></i> <span>Calzados</span>
            <span class="pull-right-container badge bg-blue">
