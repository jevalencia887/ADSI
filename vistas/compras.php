...
<!-- FIN DEL HEADER - LIBRERIAS -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Realizar Compras de Calzados a Proveedores
            ...
            <div class="box">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3">
                     ...
                     <button type="button" id="#" class="btn btn-primary" data-toggle="modal" data-target="#lista_productosModal"><i class="fa fa-plus" aria-hidden="true"></i>  Agregar Calzado</button>
                      </div>
                  </div>
