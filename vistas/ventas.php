...
<!-- FIN DEL HEADER - LIBRERIAS -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Realizar Ventas de Calzados a Clientes
            ...
            <div class="box">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-3">
                     ...
                     <button type="button" id="#" class="btn btn-primary btn_producto" data-toggle="modal" data-target="#lista_productos_ventas_Modal"><i class="fa fa-plus" aria-hidden="true"></i>  Agregar Calzado</button>
                      </div>
                  </div>
