              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            <button class="btn btn-primary btn-lg" id="add_button" onclick="limpiar()" data-toggle="modal" data-target="#productoModal"><i class="fa fa-plus" aria-hidden="true"></i> Nuevo Calzado</button></h1>
    ...
    <form class="form-horizontal" method="post" id="producto_form" enctype="multipart/form-data">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Agregar Calzado</h4>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <div class="box">
              ...
              <div class="form-group">
                  <label for="" class="col-lg-2 control-label">Calzado</label>
               ...
               <div class="form-group">
                  <label for="" class="col-lg-2 control-label">Presentación</label>
               ...
               <div class="form-group">
                  <label for="" class="col-lg-2 control-label">N# calzado</label>
              ...
              <div class="form-group">
                  <label for="" class="col-lg-2 control-label">Precio Compra</label>
               ...
               <div class="form-group">
                  <label for="" class="col-lg-2 control-label">Precio Venta</label>
              ...
              <div class="form-group">
                  <label for="" class="col-lg-2 control-label">Fecha creacion</label>
